...
def add_questions():
        questions = [('Сколько месяцы в году имеют 28 дней?', '12', '1', '0', '2'),
        ...
        ('Что не имеет длины, глубины, ширины, высоты, а можно измерить', 'Время', 'Глупость', 'Воду', 'Воздух'),
        ('Когда сетью можно выловить воду?', 'Когда вода замёрзла', 'Когда нет рыбы', 'Когда уплыла золотая рыбка','Когда сеть порвалась'),
